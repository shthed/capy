...
- **Startup restore priority.** Launching the app now resumes from the autosave whenever one exists, falling back to the most recent manual save or the bundled sample only when no autosave is stored.
