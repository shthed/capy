...
- **Core application**
  ...
  - `capy/render.js` – Combined renderer controller and WebGL backend; manages the active drawing pipeline and exposes hooks for swapping or extending renderers at runtime.
