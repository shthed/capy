...
4. **Fill regions.** Pick a colour and click/tap cells. Nearby difficulty lets you jump to adjacent colours (colour 2 can also paint 1 or 3), while Easy auto-selects any tapped colour before painting. Auto-advance hops to the next incomplete colour when enabled.
