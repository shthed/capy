...
- **Command rail** – The floating Settings cog sits in the top-right by default. Drag it anywhere on-screen (the coordinates persist in Settings) and tap to open the menu; the Gameplay tab’s Quick actions expose the preview toggle and fullscreen control alongside the usual gameplay preferences.
